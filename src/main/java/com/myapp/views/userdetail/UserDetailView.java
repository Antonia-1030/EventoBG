package com.myapp.views.userdetail;
...
@RolesAllowed("ADMIN")
@Uses(Icon.class)
public class UserDetailView extends Div implements BeforeEnterObserver {
    ...
    private MultiSelectComboBox<Role> role;
    ...
    public UserDetailView(SamplePersonService samplePersonService) {
        this.samplePersonService = samplePersonService;
        addClassNames("user-detail-view");
    ...
    public void beforeEnter(BeforeEnterEvent event) {
        ...
        if (samplePersonId.isPresent()) {
            ...
            if (samplePersonFromBackend.isPresent()) {
                ...
                // refresh grid
                refreshGrid();
                event.forwardTo(UserDetailView.class);
            }
        }
    }
    ...
    private void createEditorLayout(SplitLayout splitLayout) {
        ...
        role = new MultiSelectComboBox<>("Role");
        formLayout.add(firstName, lastName, password, email, phone, dateOfBirth, role);
